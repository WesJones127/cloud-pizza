...
export class APIGateWay extends Construct {
    ...
    constructor(scope: Construct, id: string, props: APIGateWayProps) {
        ...
        let orderReceivedLambda = createLambdaWithDynamoAccess(this, 'OrderReceivedLambda', 'order-receive', props.dynamoTable);
        ...
        let orderGetLambda = createLambdaWithDynamoAccess(this, 'OrderGetLambda', 'order-get', props.dynamoTable);
        ...
        let apiUrlSetterLambda = createLambda(this, 'ApiUrlSetterLambda', 'api-url-setter');
